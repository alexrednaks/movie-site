...
export function sidebar () {
    ...
    fetchDataFromServer(`https://api.themoviedb.org/3/genre/movie/list?api_key=
    ${api_key}`, function ({ genres }) {
    ...
    <div class="sidebar-list">
            ...
            <div class="sidebar-footer">
                <p class="copyright">
                    Copyright 2023 <a href="./index.html">
                        Chaher Skander</a>
                </p>
    ...
    const toggleSidebar = function(sidebar) {
        ...
        addEventOnElements(sidebarTogglers, "click", function() {
            sidebar.classList.toggleSidebar("active");
            sidebarBtn.classList.toggleSidebar("active");
            overlay.classList.toggleSidebar("active");
        });
